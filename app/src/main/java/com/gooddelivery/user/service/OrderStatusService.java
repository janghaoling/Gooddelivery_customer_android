...
import android.user.IntentService;
...
import com.foodie.user.build.api.ApiClient;
import com.foodie.user.build.api.ApiInterface;
import com.foodie.user.model.Order;
import com.foodie.user.model.OrderModel;
...
import static com.foodie.user.helper.GlobalData.isSelectedOrder;
import static com.foodie.user.helper.GlobalData.onGoingOrderList;
import static com.foodie.user.helper.GlobalData.pastOrderList;
import static com.foodie.user.helper.GlobalData.shouldContinueService;
