...
import static com.gooddelivery.user.helper.GlobalData.notificationCount;
import static com.gooddelivery.user.helper.GlobalData.profileModel;
        ...
        holder.cardAddTextLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (profileModel != null) {
                    Log.e("1111111111111111111111","Id in ProductAdapter::::" + product.getShopId());
