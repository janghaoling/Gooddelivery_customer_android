...
import com.gooddelivery.user.activities.ViewCartActivity;
import com.gooddelivery.user.build.api.ApiClient;
import com.gooddelivery.user.build.api.ApiInterface;
import com.gooddelivery.user.fragments.CartChoiceModeFragment;
...
import com.gooddelivery.user.models.ClearCart;
...
import static com.gooddelivery.user.helper.GlobalData.selectedShop;
...
public class HotelCatagoeryAdapter extends SectionedRecyclerViewAdapter<HotelCatagoeryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int section, final int relativePosition, int absolutePosition) {
        ...
        if (category.getName().equalsIgnoreCase(context.getResources().getString(R.string.featured_products))) {
            ...
            Log.d("1111111111111111", "Efauoasdiuf:::" + product.getFeaturedImages().size());
            if (product.getFeaturedImages().size() > 0) {
                Glide.with(context)
        ...
        holder.cardAddBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                product = list.get(section).getProducts().get(relativePosition);
                Log.e("1111111111111111111111","Id in HotelCategoryAdapter::::" + product.getShopId());
        ...
        holder.cardAddTextLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                product = list.get(section).getProducts().get(relativePosition);
                Log.e("1111111111111111111111","Id in HotelCategoryAdapter::::" + HotelViewActivity.shops.getId() + "::::" + Utils.isShopChanged(HotelViewActivity.shops.getId()));
