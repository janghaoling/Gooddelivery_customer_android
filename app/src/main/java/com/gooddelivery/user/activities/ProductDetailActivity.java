...
import com.gooddelivery.user.adapter.AddOnsAdapter;
import com.gooddelivery.user.adapter.SliderPagerAdapter;
...
import static com.gooddelivery.user.adapter.AddOnsAdapter.list;
...
//        addOnsRv.setItemAnimator(new DefaultItemAnimator());
        ...
        addItemLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.e("1111111111111111111111","Id in ProductDetailActivity::::" + product.getShopId());
