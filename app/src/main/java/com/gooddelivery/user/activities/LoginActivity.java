...
//                                map.put("client_secret", BuildConfigure.CLIENT_SECRET);
                        ...
                        public void onError(FacebookException exception) {
                            ...
                            String excpt=exception.getMessage().toString();
                            Log.e("FBException","---------"+exception.getMessage());
                        }
                    });
        } else {
...
//                handleSignInResult(result);
    ...
    private void handleSingIn(Task<GoogleSignInAccount> completedTask) {
        try {
            ...
            Runnable runnable = () -> {
                try {
                    ...
                    Log.d("Google", "Google login Result::::::::::" + account.getEmail() + ":::" + account.getDisplayName() + ":::" + account.getPhotoUrl());
                    GlobalData.name = account.getDisplayName();
                    GlobalData.email = account.getEmail();
                    GlobalData.imageUrl = "" + account.getPhotoUrl();
            ...
            Log.d("Google", "Google login Failed...." + e.getStatusCode());
        }
    }
