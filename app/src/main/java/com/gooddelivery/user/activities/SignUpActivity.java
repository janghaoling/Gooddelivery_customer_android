...
import com.gooddelivery.user.CountryPicker.Country;
import com.gooddelivery.user.CountryPicker.CountryPicker;
import com.gooddelivery.user.CountryPicker.CountryPickerListener;
...
public class SignUpActivity extends AppCompatActivity {
        ...
        switch (view.getId()) {
            ...
            case R.id.password_eye_img:
                if (passwordEyeImg.getTag().equals(1)) {
                    ...
                    passwordEyeImg.setImageDrawable(ContextCompat.getDrawable(this,
            ...
            case R.id.confirm_password_eye_img:
                if (confirmPasswordEyeImg.getTag().equals(1)) {
                    ...
                    confirmPasswordEyeImg.setImageDrawable(ContextCompat.getDrawable(this,
                            R.drawable.ic_eye_close));
    ...
    public void signup(HashMap<String, String> map) {
        ...
        call.enqueue(new Callback<RegisterModel>() {
            @Override
            public void onResponse(@NonNull Call<RegisterModel> call,
                                   @NonNull Response<RegisterModel> response) {
                if (response.body() != null) {
                    ...
                    try {
                        ...
                        if (jObjError.has("email"))
                            Toast.makeText(context, jObjError.optString("email"),
                                    Toast.LENGTH_LONG).show();
                        else if (jObjError.has("password"))
                            Toast.makeText(context, jObjError.optString("password"),
                                    Toast.LENGTH_LONG).show();
                        else if (jObjError.has("error"))
                            Toast.makeText(context, jObjError.optString("error"),
                                    Toast.LENGTH_LONG).show();
                        else
...
//                FirebaseAuth.getInstance().signOut();
            ...
            public void onResponse(@NonNull Call<LoginModel> call,
                ...
                if (response.body() != null) {
                    SharedHelper.putKey(context, "access_token",
                            response.body().getTokenType() + " " + response.body().getAccessToken());
    ...
    public void initValues() {
        ...
        if (TextUtils.isEmpty(name)) {
            Toast.makeText(this, getResources().getString(R.string.please_enter_username),
                    Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(email)) {
            Toast.makeText(this, getResources().getString(R.string.please_enter_your_email),
                    Toast.LENGTH_SHORT).show();
        } else if (!TextUtils.isValidEmail(email)) {
            Toast.makeText(this, getResources().getString(R.string.please_enter_valid_email),
                    Toast.LENGTH_SHORT).show();
        } else if (!isValidMobile(etMobileNumber.getText().toString()) && !GlobalData.loginBy.equals("manual")) {
            Toast.makeText(this,
                    getResources().getString(R.string.please_enter_your_mobile_number),
                    Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(password) && GlobalData.loginBy.equals("manual")) {
            Toast.makeText(this, getResources().getString(R.string.please_enter_password),
                    Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(strConfirmPassword) && GlobalData.loginBy.equals("manual")) {
            Toast.makeText(this,
                    getResources().getString(R.string.please_enter_your_confirm_password),
                    Toast.LENGTH_SHORT).show();
        } else if (!strConfirmPassword.equalsIgnoreCase(password) && GlobalData.loginBy.equals(
                "manual")) {
            Toast.makeText(this,
                    getResources().getString(R.string.password_and_confirm_password_doesnot_match), Toast.LENGTH_SHORT).show();
        } else {
            HashMap<String, String> map = new HashMap<>();
            map.put("name", name);
            map.put("email", email);
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        if (jObjError.has("phone"))
                            Toast.makeText(context, jObjError.optString("phone"),
                                    Toast.LENGTH_LONG).show();
